  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 sm:px-10 relative overflow-hidden bg-white">
      ...
      <h1
        ...
        className="text-3xl sm:text-5xl md:text-6xl font-light mb-4 leading-tight"
      >
        Our Story Begins...
      </h1>
      <p
      ...
      >
        Every great journey starts with a single step, and ours began with a
        look that changed everything forever.
      </p>
